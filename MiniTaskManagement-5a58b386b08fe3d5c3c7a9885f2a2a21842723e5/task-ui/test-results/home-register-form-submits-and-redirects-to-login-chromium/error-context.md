...
- Name: home.spec.ts >> register form submits and redirects to login
- Location: tests\home.spec.ts:26:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:3000/register
Call log:
